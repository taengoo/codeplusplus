...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
      ...
      <h3 class="section-header">VARIABLES</h3>
      <p>
<?php echo nl2br(
...
"); ?>
      ...
      <h3 class="section-header">Numbers</h3>
      <p>
<?php echo nl2br(
...
console.log(foo % 2);   // remainder: 1
      ...
      <h3 class="section-header">Boolean</h3>
      <p>
<?php echo nl2br(
...
console.log(!false);         // true
      ...
      <h3 class="section-header">Arrays</h3>
      <p>
<?php echo nl2br(
...
console.log(foo[0]); // prints 2
      ...
      <h3 class="section-header">Object Literals</h3>
      <p>
<?php echo nl2br(
